---
title: The Main Event Barbershop
description: The Main Event Barbershop - Your Premier barbershop destination in Concord CA
intro: We specialize in services from old school razor shaves to more trending
  styles, such as fades, tapers, faux hawks, and more.
hero_template: image
template: full
container: md
hero_buttons:
  ...
  - type: pricing
    ...
    prices:
      - title: Jeremy Carrier
        ...
        features:
          - label: Fast
      - title: Rolando Zamora
        intro: (925) 325-1111
        price: "50"
        buttons:
          - icon_only: false
            label: BOOK APPOINTMENT
            href: https://www.squareup.com/appointments/book/b9s6deqc01wt7/rolando-fran-zamora
        features:
          - label: Great service
style:
  hero_template: image
